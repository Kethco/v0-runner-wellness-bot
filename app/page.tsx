  ...
  <div className={`min-h-screen bg-black text-white pb-20 ${showTrialBanner ? "pt-10" : ""}`}>
      ...
      <header className="fixed-header-safe z-50 border-b border-[#3A3A3C]">
        <div className="px-4 py-2 flex items-center justify-between">
          <div>
            <p className={`text-xs font-bold bg-gradient-to-r ${greeting.gradient} bg-clip-text text-transparent`}>{greeting.text}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              >
                <Flame className="w-4 h-4 text-white drop-shadow-[0_0_8px_rgba(255,200,0,0.8)]" />
              </motion.div>
      ...
      <main className="px-5 py-6 space-y-6 mt-[145px]">
