    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error === "Unauthorized" 
          ? "Please log in to save your goal" 
          : data.error || "Failed to save goal");
      }
    } catch {
        ...
        <DialogContent className="bg-card border-border">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label>Race Distance <span className="text-destructive">*</span></Label>
            ...
            <div className="space-y-2">
              <Label>Race Date <span className="text-destructive">*</span></Label>
              <Input
                type="date"
                value={raceDate}
      ...
      <Card className="bg-card border-border p-4 relative overflow-hidden">
        {!activeGoal ? (
          <div className="flex flex-col items-center justify-center py-4 text-center">
            ...
            <Button variant="outline" size="sm" className="gap-1" onClick={openDialog}>
